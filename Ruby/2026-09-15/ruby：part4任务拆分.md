...
|---------|------------|------------------|-------------|--------------|----------|------------|----------------------|-------------------|--------|
| T01 | PB-01 | 列出转诊核验涉及的角色与权限边界（秘书可补件、不可接受转诊） | Ruby | Estrella | 2h | Part 1 摘要 | 角色表与案例规则一致 | 权限表 | Done |
| T02 | PB-01 | 起草转诊主路径：收件 → 核材料 → 送 Consultant | Ruby | Ryan | 3h | T01 | 主路径步骤可对应案例原文 | BPMN 草稿 | Not started |
...
| T20 | PB-15 | 准备 Sprint Review 演示顺序与未完成项说明 | Ruby | Estrella | 2h | 当前增量 | Ruby、Estrella、Ender、Ryan 分段清楚 | Review 讲稿 | In progress |
